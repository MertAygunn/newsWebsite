...
const Carousel = () => {
  const images = [
    "https://img.youtube.com/vi/Zko1CH5FE00/maxresdefault.jpg", // Yerel resim
    "https://img.youtube.com/vi/aN0bn4sa7eQ/maxresdefault.jpg", // Harici resim
    "https://img.youtube.com/vi/DuNu6AxnhtM/maxresdefault.jpg", // Harici resim
  ];
